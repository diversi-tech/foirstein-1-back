...
public partial class Librarydb32cvContext : DbContext
{
    public Librarydb32cvContext()
    {
    }

    public Librarydb32cvContext(DbContextOptions<Librarydb32cvContext> options)
        : base(options)
    {
    }
